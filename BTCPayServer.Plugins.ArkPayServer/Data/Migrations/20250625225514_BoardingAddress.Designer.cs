...
namespace BTCPayServer.Plugins.ArkPayServer.Data.Migrations
{
    ...
    [Migration("20250625225514_BoardingAddress")]
    partial class BoardingAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.ArkPayServer.Data.Entities.ArkWallet", b =>
                {
                    ...
                    b.Property<byte[]>("EncryptedPrvkey")
                        .IsRequired()
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.ArkPayServer.Data.Entities.BoardingAddress", b =>
                {
                    b.Property<string>("OnchainAddress")
                        .HasColumnType("text");

                    b.Property<long>("BoardingExitDelay")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("OnchainAddress");

                    b.HasIndex("WalletId", "DerivationIndex")
                        .IsUnique();

                    b.ToTable("BoardingAddresses", "BTCPayServer.Plugins.Ark");
                });
